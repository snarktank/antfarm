...
describe('Stories Section Migration (US-009)', () => {
  ...
  describe('Stories section container', () => {
    ...
    it('uses Tailwind classes for border color with dark mode', () => {
      assert.ok(html.includes('border-border-default dark:border-dark-border-default'), 'Should use Tailwind border classes');
    });
  ...
  describe('Stories h3 title', () => {
    ...
    it('uses Tailwind classes for text color with dark mode', () => {
      ...
      assert.ok(h3Match[0].includes('text-text-primary dark:text-dark-text-primary'), 'Should use Tailwind text classes');
    });
  ...
  describe('Retry count indicator', () => {
    ...
    it('uses Tailwind classes for orange color with dark mode', () => {
      ...
      assert.ok(retryMatch[0].includes('text-accent-orange dark:text-dark-accent-orange'), 'Should use Tailwind accent classes');
    });
